...
import { matchingItem, disCheckoutQuan, addToCart, disWishQuan,addToWishlist } from "./data.js";
import { carte } from "./data.js";
...
document.querySelector('.pro-container1').innerHTML = productHtml;
